...
window.addEventListener("DOMContentLoaded", function(){
	...
	document.getElementById("MS_upbutton").addEventListener("mousedown", function(){window.event.preventDefault(); window.scroll(0,0);}, true);
