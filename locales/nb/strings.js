var strings = {
	...
	"disable standard bars" : "Opera's standard scrollbars should be disabled to avoid double bars.<br>To do so, go to Opera → Innstillinger → Innstillinger... → Avansert → Nettleser and deactivate \"Vis rullefelt\" there",
