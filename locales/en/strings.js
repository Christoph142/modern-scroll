var strings = {
	...
	"disable standard bars" : "Opera's standard scrollbars should be disabled to avoid double bars.<br>To do so, go to Opera → Settings → Preferences... (Ctrl+F12) → Advanced → Browsing and deactivate \"show scroll bars\" there",
