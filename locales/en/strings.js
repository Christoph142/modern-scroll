var strings = {
	...
	"always" : "always",
	"note" : "Note",
	"disable standard bars" : "If you don't want Opera's standard scrollbars to pop up for a moment during page loading, you may disable them completely.<br>To do so, go to Opera → Settings → Preferences... → Advanced → Browsing and deactivate \"show scroll bars\" there.<br>Be aware though, that it's not recommended since they can be neither used as a fallback method nor will they show up on Opera's internal pages, which don't allow any extensions to be executed for security reasons, anymore in this case.",
