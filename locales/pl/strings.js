var strings = {
	...
	"disable standard bars" : "Opera's standard scrollbars have to be disabled in order to be able to see these ones.<br>To do so, go to Opera → Settings → Preferences... → Advanced → Browsing and deactivate \"show scroll bars\" there",
