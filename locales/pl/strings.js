var strings = {
	...
	"disable standard bars" : "Opera's standard scrollbars should be disabled to avoid double bars.<br>To do so, go to Opera → Ustawienia → Preferencje... → Zaawansowane → Przegladanie and deactivate \"Pokaz paski przewijania\" there",
